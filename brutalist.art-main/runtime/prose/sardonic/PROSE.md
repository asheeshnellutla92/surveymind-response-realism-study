...
The register for **@Musinique** (`claude-musinique`).
...
**Output:** a rewrite saved to `prose/sardonic/<same-filename>.md`. **Markdown only.**
...
```
Rewrite chapters/<file>.md in the Sardonic voice per prose/sardonic/PROSE.md.
...
LLM exercises, and any images. Save to prose/sardonic/<file>.md — never touch
